...
# ひみつ道具、真の姿に！？
供与元の ~~タコピー~~ 総統から「僕の展示と同じ仕様にしてください。その為のパーツは供与しましたよね？」と要求があった。
確かに ~~アナハイムエレクトロニクス~~ 総統からは専用改造ケースやLED照明を渡されていた。
...
|LED照明ユニット|4本|総統が中国より取り寄せたユニット 1本で正方形1辺を構成する|
...
また、ここで未実装であったダイソーフリーマルチネット35cm x 35cm を実装する。
